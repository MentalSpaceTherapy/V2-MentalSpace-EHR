        ...
        <div className="container p-6 max-w-7xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border">
            <div className="text-center py-12">
              <h2 className="text-xl font-medium mb-3">Client Acquisition Coming Soon</h2>
              <p className="text-neutral-500 max-w-md mx-auto">
                This section will provide tools to track leads, manage your acquisition pipeline, and analyze conversion rates for your therapy practice.
              </p>
            </div>
          </div>
        </div>
